 ...
 */
    ...
    (() => {
        ...
        let _slideUp = (target, duration = 800, showmore = 0) => {
        ...
        let _slideDown = (target, duration = 800, showmore = 0) => {
            if (!target.classList.contains("_slide")) {
                target.classList.add("_slide");
            ...
            if (spollersArray.length > 0) {
                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("[data-spoller]")) {
                        ...
                        const spollerSpeed = spollersBlock.dataset.spollersSpeed ? parseInt(spollersBlock.dataset.spollersSpeed) : 800;
        ...
        function menuInit() {
            const menuButton = document.querySelector(".menu__buttons");
            document.querySelector(".bottom-header__menu");
            document.querySelectorAll(".menu__link > button");
            const menuItems = document.querySelectorAll(".menu__item");
            const menuSubItem = document.querySelectorAll(".menu__subitem");
            const menuSubItems = document.querySelectorAll(".menu__sublink > button");
            if (menuButton) {
                ...
                menuItems.forEach((item => {
                    item.addEventListener("click", (function(e) {
                        ...
                        if (!target.closest(".menu__items")) {
                            let elem_active = item.classList.contains("_active");
                            menuItems.forEach((el => {
                                el.classList.remove("_active");
                            }));
                            item.classList.toggle("_active", !elem_active);
                        }
                    }));
                }));
                menuSubItems.forEach((subitem => {
                    subitem.addEventListener("click", (function(e) {
                        if (e.target.closest(".menu__sublink > button")) menuSubItem.forEach((item => {
                            let elem_active = item.classList.contains("_active");
        ...
        function formQuantity() {
            ...
            const quantityBlock = document.querySelectorAll(".add-product-card__column");
        ...
        class SelectConstructor {
            constructor(props, data = null) {
                ...
                this.selectClasses = {
                    ...
                    classSelectContent: "select__content _icon-arrow-2",
 ...
 */
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                var snapValues = [ rangeItem.querySelector("[data-range-from]"), rangeItem.querySelector("[data-range-to]") ];
        ...
        document.querySelectorAll(".images-product").forEach((n => {
            const thumbsSwiper = new core(n.querySelector(".images-product__thumbs"), {
            ...
            const thumbsSwiper_2 = new core(n.querySelector(".images-product__thumbs-2"), {
                modules: [ Navigation, Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
            ...
            new core(n.querySelector(".images-product__slider-2"), {
                modules: [ Navigation, Thumb ],
                thumbs: {
        ...
        if (tippyIcons) tippyIcons.forEach((icon => {
            icon.addEventListener("click", (function(e) {
                let elem_active = icon.classList.contains("_active");
                tippyIcons.forEach((el => {
                    el.classList.remove("_active");
                }));
            ...
            window.addEventListener("click", (e => {
                const target = e.target;
                if (!target.closest(".features-product-card__icon") && !target.closest(".features-product-card__icon-tippy")) icon.classList.remove("_active");
            }));
        }));
        document.addEventListener("click", (({target}) => {
            ...
            if (null === image || null === activeButton) return;
